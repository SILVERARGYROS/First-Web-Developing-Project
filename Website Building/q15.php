...
<html>
    ...
    <body>
        ...
        <h3>Ερώτημα Q15:<br>
        Να παρουσιάσετε τον θερμότερο και τον ψυχρότερο νομό, μαζί με τις πιο ακραίες μέγιστες
        ...
        <table border="1">
            <tr>
                <th>όνομα_νομού</th>
                <th>μέσος_όρος_θερμοκρασιών</th>
                <th>ψυχρότερη_θερμοκρασία</th>
                <th>θερμότερη_θερμοκρασία</th>
            </tr>
            <?php
