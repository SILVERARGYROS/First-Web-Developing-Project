...
<html>
    <head>
        ...
        <title>db1u10 Clear Data Page</title>
    </head>
    ...
    <body>
        ...
        <h3>Εκκαθάριση Δεδομένων Μ. Δεδομένων</h3>
        <h1>
            Εκκαθάριση βάσης από όλα τα δεδομένα Μ. Δεδομένων και θα και θα επαναφέρει την ανάλογη ακολουθία αρίθμησης.<br>
            <br>
            <p style='color: red'>
        ...
        <p style='color: red'>
            ...
            <?php
                if(isset($_GET["submit"]))
                {
                    ...
                    $query = "truncate table Μ_Δεδομένα cascade;";
