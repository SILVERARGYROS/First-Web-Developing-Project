...
<html>
    <head>
        ...
        <title>db1u10 Clear Occurances Page</title>
    </head>
    ...
    <body>
        ...
        <h3>Εκκαθάριση Δεδομένων συσχέτισης "ΕΚΔΗΛΩΘΗΚΑΝ"</h3>
        <h1>
            Εκκαθάριση βάσης από όλα τα δεδομένα της συσχέτισης "ΕΚΔΗΛΩΘΗΚΑΝ".<br>
            <br>
            <p style='color: red'>
