...
<html>
    <head>
        ...
        <title>db1u10 Clear Locations Page</title>
    </head>
    ...
    <body>
        ...
        <h3>Εκκαθάριση Δεδομένων Δήμων</h3>
        <h1>
        Εκκαθάριση βάσης από όλα τα δεδομένα Δήμων και θα και θα επαναφέρει την ανάλογη ακολουθία αρίθμησης.<br>
            <br>
            <p style='color: red'>
        ...
        <p style='color: red'>
            ...
            <?php
                if(isset($_GET["submit"]))
                {
                    ...
                    $query = "truncate table Δήμοι cascade;";
