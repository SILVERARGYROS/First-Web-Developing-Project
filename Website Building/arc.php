...
<html>
    <head>
        ...
        <title>db1u10 Architecture Page</title>
    </head>
    ...
    <body>
        ...
        <h3>Αρχιτεκτονική</h3>
        <h1>Προβολή κώδικα κατασκευής βάσης δεδομένων</h1>
    ...
    AND Μ_Δεδομένα.ημερομηνία = meteo_temp.date AND (Μ_Δεδομένα.μέση_θερμοκρασία = meteo_temp.avg_temp_C OR (Μ_Δεδομένα.μέση_θερμοκρασία IS NULL AND meteo_temp.avg_temp_C IS NULL)) 
