...
<html>
    ...
    <body>
        ...
        <h3>Architecture</h3>
        <h1>Showcasing how all the tables were build:</h1>

        <pre><code class="language-SQL">
        --Deletes all tables, in case we ever need to rebuild the database

        drop table fire_temp, locations_temp, meteo_temp, statons_temp, Δασικές_Πυρκαγές, Δήμοι, Μ_Σταθμοί, Μ_Δεδομένα, ΣΤΑΘΜΟΣ_ΑΝΑΦΟΡΑΣ, ΕΚΔΗΛΩΘΗΚΑΝ, ΚΑΤΑΓΡΑΦΕΣ;
