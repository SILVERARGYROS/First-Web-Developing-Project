...
<html>
    ...
    <body>
        ...
        <h3>Αρχιτεκτονική Βάσης</h3>
        <h1 style='width: max-content;'>Εδώ μπορείτε να δείτε τον κώδικα με τον οποίο έχει υλοποιηθεί η βάση.</h1>
    ...
    --Builds final tables and relation tables
