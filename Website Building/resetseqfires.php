...
<html>
    <head>
        ...
        <title>db1u10 Reset Fires Sequence Page</title>
    </head>
    ...
    <body>
        ...
        <h3>Επαναφορά Αλληλουχιών Αρίθμησης Δασικών Πυρκαγών</h3>
        <h1>
        ...
        <p style='color: red'>
            ...
            <?php
                if(isset($_GET["submit"]))
                {
                    ...
                    $query = "ALTER SEQUENCE Δασικές_Πυρκαγιές_id_seq RESTART;";
                    
                    $result = pg_query($link, $query) or die("Αποτυχία επαναφοράς αλληλουχίας!"); 
